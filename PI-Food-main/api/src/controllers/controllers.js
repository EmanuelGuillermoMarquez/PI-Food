...
const getAllRecipes = async (value) => {
    ...
    let apiResult = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=${API_KEY4}&addRecipeInformation=true&number=100`)
...
const getRecipeById = async (id) => {
    ...
    if(!isNaN(id)) {
        ...
        const result = await axios.get(`https://api.spoonacular.com/recipes/${id}/information?apiKey=${API_KEY4}`)
            .then((res) => res.data)
            .catch((err) => {
